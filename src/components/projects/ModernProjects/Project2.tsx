...
const projects = [
  ...
  },
  {
    ...
    image: "/images/project/p21.png?height=600&width=800",
  ...
  },
  {
    ...
    image: "/images/project/p23.jpeg?height=600&width=800",
    category: "Mobile App",
  ...
  },
  {
    ...
    image: "/images/project/p25.jpg?height=600&width=800",
    category: "Mobile App",
...
export default function Project2() {
  ...
  return (
    <section className="w-full py-6 md:py-8 lg:py-8 bg-muted/30">
